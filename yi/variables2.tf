# Environment
variable prefix { default = "jt" }
variable uname { default = "jthomsonf5" }
...
variable owner { default = "jamest" }
variable group { default = "segroup" }
variable costcenter { default = "f5" }
variable application { default = "testterraform" }
