# Environment
variable prefix { default = "mt-dev-eus2-dmzfw" }
...
variable owner { default = "yz4898" }
variable group { default = "attlabs" }
variable costcenter { default = "att" }
variable application { default = "mobility-transit" }
